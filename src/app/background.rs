...
pub fn background_draw<G: Graphics>(
    ...
    let line = line::Line::new(BACKGROUND_COLOR, 2.);
    ...
    rectangle(
        BACKGROUND_COLOR,
        [0., 0., winfo.gridoffsets.0, winfo.window_size.1 as f64],
        c.transform,
        g,
    );
    rectangle(
        BACKGROUND_COLOR,
        [0., 0., winfo.window_size.0 as f64, winfo.gridoffsets.1],
        c.transform,
        g,
    );
    rectangle(
        BACKGROUND_COLOR,
        [
            winfo.window_size.0 as f64 - winfo.gridoffsets.0,
            0.,
            winfo.gridoffsets.0,
    ...
    rectangle(
        ...
        [
            0.,
            winfo.window_size.1 as f64 - (winfo.offsets.1 + winfo.margin as f64),
            winfo.window_size.0 as f64,
            winfo.offsets.1 + winfo.margin as f64,
        ],
        c.transform,
        g,
    );
